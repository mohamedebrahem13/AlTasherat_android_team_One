...
class LanguageViewModel@Inject constructor() : AlTasheratViewModel <LanguageContract.LanguageAction, LanguageContract.LanguageEvent, LanguageContract.LanguageViewState>(LanguageContract.LanguageViewState.initial()) {
