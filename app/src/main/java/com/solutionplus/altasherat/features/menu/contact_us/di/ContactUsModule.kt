package com.solutionplus.altasherat.features.menu.contact_us.di

import com.solutionplus.altasherat.common.domain.repository.local.IKeyValueStorageProvider
import com.solutionplus.altasherat.features.menu.contact_us.data.repository.ContactUsRepository
import com.solutionplus.altasherat.features.menu.contact_us.domain.repository.local.IContactDataSource
import com.solutionplus.altasherat.features.menu.contact_us.domain.repository.IContactUsRepository
import com.solutionplus.altasherat.features.menu.contact_us.domain.repository.intractor.CheckTokenKeyUC
import com.solutionplus.altasherat.features.menu.contact_us.data.repository.local.ContactUsLocalDS
